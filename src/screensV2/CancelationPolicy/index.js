    ...
    <SafeAreaView>
      <View style={[styles.mainContent]}>
        ...
        <Typography variant="large">
          ...
          mind that Renit’s Extenuating Circumstance policy doesn’t cover cancellations due to
          illness or travel disruptions caused by COVID-19.
        </Typography>
        <Typography variant="large" bold style={{marginTop: 35, marginBottom: 30}}>
          Cancel by
        </Typography>
        <FlatList data={privacyData} renderItem={renderItem} keyExtractor={keyExtractor} />
