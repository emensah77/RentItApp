    ...
    <View style={styles.mainContent}>
      ...
      <View style={styles.rentSaleStep}>
        <View style={styles.rentSaleStepOption}>
          ...
          <Typography style={styles.rentSaleStepLightText}>
            You are renting your home to tenants, and require monthly payments and offering a stay
            limited by a time agreed upon.
          </Typography>
        </View>
        <View style={styles.rentSaleStepOption}>
          <Typography style={styles.rentSaleStepBoldText}>For Sale</Typography>
          <Typography style={styles.rentSaleStepLightText}>
            You are selling your home for a stipulated amount and are not offering a stay limited by
            time.
          </Typography>
        </View>
      </View> */}
