...
const AppStack = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name={'Number of Guests'} component={GuestsScreen} />
      <Stack.Screen name={'House Type'} component={HouseTypeScreen} />

      <Stack.Screen name={'Post'} component={PostScreen} />
      <Stack.Screen name={'Reviews'} component={Review} />
      <Stack.Screen name={'Feedback'} component={EFeedback} />
    </Stack.Navigator>
  );
};
