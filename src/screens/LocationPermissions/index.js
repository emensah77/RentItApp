    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 30 }}>
                <Image source={require('../../../assets/data/images/locationPin.png')} style={{ width: 300, height: 380 }} />
                <View style={{ paddingHorizontal: 15 }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginVertical: 10 }}>
                        <Text style={{ fontSize: 18, fontWeight: '800' }}>Enable Geolocation</Text>
                    </View>
                    <Text
                        style={{
                            fontSize: 14,
                        ...
                        Rentit uses your location to provide you with relevant recommendations about homes near you, and notifications for price changes in homes near you, including when the app is in the background.
                    </Text>
