...
import { View, Modal, TextInput, ActivityIndicator, Text, Linking, Platform, Pressable, ImageBackground, SafeAreaView, PermissionsAndroid, ScrollView, Image, FlatList, TouchableOpacity, Alert, BackHandler, ToastAndroid } from "react-native";
...
const HomeScreen = (props) => {
  ...
  const hasPermissionIOS = async () => {
    ...
    if (status === 'disabled') {
      Alert.alert(
        `Turn on Location Services to allow "${user?.displayName}" to determine your location.`,
        '',
        [
