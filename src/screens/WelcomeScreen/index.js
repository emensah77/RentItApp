...
const WelcomeScreen = ({ props }) => {
    ...
    return (
        <View style={{ flex: 1, top: 100, padding: 10, backgroundColor: 'white' }}>
            ...
            <Text style={{ fontWeight: '400', fontSize: 14, padding: 10 }}>We really hope you find the home you love, because we truly
            ...
            <View style={{ paddingHorizontal: 20, marginTop: 5 }}>
                ...
                />
                <Text style={{ alignSelf: 'flex-end', fontSize: 10, marginBottom: 13, color: 'blue' }}>Make sure it matches the name on your government ID.</Text>
                <Text style={{
                    marginBottom: 8,
                    fontSize: 13,
                    fontWeight: "600",
                ...
                <TextInput
                    ...
                    editable={false}
                />
                <Text style={{ alignSelf: 'flex-end', fontSize: 10, marginBottom: 13, color: 'blue' }}>We'll email you home confirmations and receipts.</Text>
            </View>
            ...
            <View>
                <Text style={{ fontWeight: '400', fontSize: 14, paddingHorizontal: 20 }}>
                    ...
                    <Text style={{ textDecorationLine: 'underline', color: 'blue' }}> Terms of Service</Text> ,
                    <Text style={{ textDecorationLine: 'underline', color: 'blue' }}> Payment Terms of Service</Text> and acknowledge the
            ...
            <TouchableOpacity
                ...
                style={{
                    borderRadius: 15, backgroundColor: 'deeppink', width: 200,
                    height: 50, marginLeft: 10, justifyContent: 'center', alignItems: 'center',
                    marginTop: 25, alignSelf: 'flex-end', marginHorizontal: 25
                }}>
