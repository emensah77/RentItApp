            ...
            <Modal style = {{flex: 1,
                        ...
                        >
                            ...
                            <ScrollView contentContainerStyle={{flexGrow:1,flexDirection:"column", justifyContent:"space-evenly"}}>
                                ...
                                <Text style={{paddingTop:10,fontWeight:'600', marginBottom:20}}>Enter your mobile money number. This is the same number you will use to make payment</Text>
                            <TextInput
                              adjustsFontSizeToFit={true}
                              keyboardType="numeric"
                            ...
                            <TouchableOpacity disabled={value === '' || selectedItems.length === 0  || checkoutNumber.length < 10? true : false} onPress={() => submitPayment()}
                             style={{opacity: value === '' || selectedItems.length === 0  || checkoutNumber.length < 10? .5 : 1,height:40,margin:20,borderRadius:10,alignItems:"center",backgroundColor:"black"}}>
