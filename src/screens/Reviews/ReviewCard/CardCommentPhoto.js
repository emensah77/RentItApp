  ...
  return (
    <View style={[styles.contain, style]}>
      <View style={{ flexDirection: 'row', marginBottom: 10 }}>
        <Image
          source={{ uri: userInfo?.userImg || 'https://w7.pngwing.com/pngs/754/2/png-transparent-samsung-galaxy-a8-a8-user-login-telephone-avatar-pawn-blue-angle-sphere-thumbnail.png', width: 200, height: 200 }}
          style={styles.thumb}
        />
        <View
          style={{
