...
const OnboardingScreen9 = (props) => {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.text_header}> Let's give your  {'\n'} place a title</Text>
      </View>
        ...
        <ScrollView>
            ...
            <View style={{flex:1, flexDirection:'row', justifyContent:'space-between'}}>
                   ...
                   <View style={{flex:1, marginBottom:20, alignItems:'center'}}>
                        ...
                        placeholder="Example: Beautiful 3 bedroom flat"
                        multiline={true}
                        maxLength={50}
            ...
            <TouchableOpacity disabled={value.length === 0} onPress={async() => 
            {
            await saveProgress({title: value, type: type, bed: bed, bedroom: bedroom, bathroom: bathroom, mode: mode})
