...
import {View, Linking,TouchableOpacity,Dimensions,StatusBar,Pressable,StyleSheet,ScrollView,Text} from 'react-native';
        ...
        >
            ...
            >
                ...
                <FastImage style={styles.image}
                    ...
                    <Text style={{fontFamily:'Montserrat-Bold'}} numberOfLines={2}>{hometitle}</Text>
                    <View style={styles.hairline}/>
                    <View style={{paddingBottom:40}}>
                        <Text style={{fontSize:16,paddingBottom:20,fontFamily:'Montserrat-Bold'}}>Reservation Details</Text>
                        ...
                        <Text style={{paddingBottom:5, fontFamily:'Montserrat-SemiBold'}}>{homeyears} years</Text>
                        <Text style={{paddingBottom:5, fontFamily:'Montserrat-SemiBold'}}>{homemonths} months</Text>
                        <View style={styles.hairline2}/>
                        <Text style={{paddingBottom:5, fontFamily:'Montserrat-Bold'}}>Payment info</Text>
                        <Text style={{paddingBottom:5, fontFamily:'Montserrat-SemiBold'}}>Total Cost: GH₵ {homeamount}</Text>
                    </View>
                    ...
                    style={{paddingBottom:40}}>
                        <Text style={{fontSize:16,paddingBottom:15,fontFamily:'Montserrat-Bold'}}>Getting there</Text>
                        <Text style={{fontSize:12,paddingBottom:5,fontFamily:'Montserrat-Bold'}}>Click on the map to get directions to your new home</Text>
                        ...
                        <Marker coordinate = {{latitude: homelatitude,longitude: homelongitude}}
